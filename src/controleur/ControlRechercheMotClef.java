...
public class ControlRechercheMotClef {
	//Attributs
	private static String fichierResultat = "src/modele/recherche/motClef/rechercheMotClefOut.txt";
	...
	private void runRechercheTexte(String args){
		String s;
		try {
			System.out.println("./src/modele/recherche/motClef/rechercheMotClef.out " + args) ;
			Process p = Runtime.getRuntime().exec("./src/modele/recherche/motClef/rechercheMotClef.out " + args);
