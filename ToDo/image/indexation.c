...
int indexationTotale(){
    ...
    descripteur descripteurCourant;
    FILE * fichier = NULL;


    FILE * newFichierIndexes = NULL;
    newFichierIndexes = fopen("../../../../data/TMP_fichiersIndexesImage","a");
    ...
    while(fgets(fichierCourant,1024,fichierIndexes)!=NULL){
        ...
        sprintf(cheminFichierCourant,"../../../../base_de_document/Image/%s",fichierCourant);

        fichier = fopen(cheminFichierCourant,"r");
        if(fichier!=NULL){
            generer_descripteur(descripteurCourant, )
