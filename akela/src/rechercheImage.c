...
//    DONNEES EN DUR
    IvySendMsg("Baloo type=RESULT file=%s score=%f","./baseDeDocuments/Image/NB/52.bmp"
                                                                        ,87.56);

    IvySendMsg("Baloo type=RESULT file=%s score=%f","./baseDeDocuments/Image/NB/53.bmp"
                                                                        ,53.12);
/*
    fprintf(output,"%s;%.2f\n",""
                              ,87.56
